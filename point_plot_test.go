...
<circle cx="400.00" cy="0.00" r="5"/>
		...
		plot, err := DrawPoint(200, 400, 10, 10, []int{-3, -2, -1, 0, 1, 2, 3}, []int{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
...
<circle cx="400.00" cy="0.00" r="5"/>
		...
		plot, err := DrawPoint(200, 400, 10, 10, []float32{-3, -2, -1, 0, 1, 2, 3}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
	...
	}
	{
		testId = 3
		t.Logf("Test %d\tstart", testId)
		_, err := DrawPoint(200, 400, 10, 10, []float32{-3, 0, 1, 2, 3}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
	...
	}
	{
		testId = 4
		t.Logf("Test %d\tstart", testId)
		_, err := DrawPoint(200, 400, 10, 10, []float32{}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawPoint(200, 400, 10, 10, []float32{9, 4, 1, 0, 1, 4, 9}, []float32{}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
...
<circle cx="200.00" cy="18.70" r="5"/>
		...
		plot, err := DrawPointFrom0(200, 200, 5, 5, []uint8{0, 1, 2, 3}, []uint8{0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
...
<circle cx="200.00" cy="18.70" r="5"/>
		...
		plot, err := DrawPointFrom0(200, 200, 5, 5, []float32{0, 1, 2, 3}, []float32{0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
	...
	}
	{
		testId = 3
		t.Logf("Test %d\tstart", testId)
		_, err := DrawPointFrom0(200, 400, 10, 10, []float32{3, 0, 1, 2, 3}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 4
		t.Logf("Test %d\tstart", testId)
		_, err := DrawPointFrom0(200, 400, 10, 10, []float32{}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawPointFrom0(200, 400, 10, 10, []float32{9, 4, 1, 0, 1, 4, 9}, []float32{}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawPointFrom0(200, 400, 10, 10, []float32{1, -2, 3}, []float32{1, 2, 3}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
...
func TestDrawPointFloat64(t *testing.T) {
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawPointFloat64(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawPointInt(t *testing.T) {
	type testCase struct {
		x, y []int
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawPointInt(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawPointInt64(t *testing.T) {
	type testCase struct {
		x, y []int64
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawPointInt64(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawPointFloat64From0(t *testing.T) {
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawPointFloat64From0(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawPointIntFrom0(t *testing.T) {
	type testCase struct {
		x, y []int
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawPointIntFrom0(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawPointInt64From0(t *testing.T) {
	type testCase struct {
		x, y []int64
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawPointInt64From0(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
