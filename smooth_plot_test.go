...
<path d="M 16.00 187.00 C 16.00,187.00 66.729,174.77 77.33,168.30 C 98.23,155.56 123.017,131.29 138.67,112.20 C 138.67,112.20 173.212,63.84 200.00,18.70 " fill="none" stroke="black" stroke-width="3" stroke-linecap="round"/>
		...
		plot, err := DrawSmoothFromZero(200, 200, 5, 5, []float64{0, 1, 2, 3}, []float64{0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
...
<path d="M 16.00 187.00 C 16.00,187.00 66.729,174.77 77.33,168.30 C 98.23,155.56 123.017,131.29 138.67,112.20 C 138.67,112.20 173.212,63.84 200.00,18.70 " fill="none" stroke="black" stroke-width="3" stroke-linecap="round"/>
	...
	}
	{
		testId = 3
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFromZero(200, 400, 10, 10, []float64{3, 0, 1, 2, 3}, []float64{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 4
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFromZero(200, 400, 10, 10, []float64{}, []float64{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFromZero(200, 400, 10, 10, []float64{9, 4, 1, 0, 1, 4, 9}, []float64{}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFromZero(200, 400, 10, 10, []float64{1, -2, 3}, []float64{1, 2, 3}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
