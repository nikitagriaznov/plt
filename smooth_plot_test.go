...
<path d="M 16.00 0.00 C 16.00,0.00 65.191,84.66 80.00,103.89 C 96.19,124.91 121.953,151.91 144.00,166.22 C 160.35,176.84 188.800,187.00 208.00,187.00 C 227.20,187.00 255.647,176.84 272.00,166.22 C 294.05,151.91 319.813,124.91 336.00,103.89 C 336.00,103.89 372.142,50.03 400.00,0.00 " fill="none" stroke="black" stroke-width="3" stroke-linecap="round"/>
		...
		plot, err := DrawSmooth(200, 400, 10, 10, []int{-3, -2, -1, 0, 1, 2, 3}, []int{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
...
<path d="M 16.00 0.00 C 16.00,0.00 65.191,84.66 80.00,103.89 C 96.19,124.91 121.953,151.91 144.00,166.22 C 160.35,176.84 188.800,187.00 208.00,187.00 C 227.20,187.00 255.647,176.84 272.00,166.22 C 294.05,151.91 319.813,124.91 336.00,103.89 C 336.00,103.89 372.142,50.03 400.00,0.00 " fill="none" stroke="black" stroke-width="3" stroke-linecap="round"/>
		...
		plot, err := DrawSmooth(200, 400, 10, 10, []float32{-3, -2, -1, 0, 1, 2, 3}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
	...
	}
	{
		testId = 3
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmooth(200, 400, 10, 10, []float32{-3, 0, 1, 2, 3}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
	...
	}
	{
		testId = 4
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmooth(200, 400, 10, 10, []float32{}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmooth(200, 400, 10, 10, []float32{9, 4, 1, 0, 1, 4, 9}, []float32{}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
...
<path d="M 16.00 187.00 C 16.00,187.00 66.729,174.77 77.33,168.30 C 98.23,155.56 123.017,131.29 138.67,112.20 C 138.67,112.20 173.212,63.84 200.00,18.70 " fill="none" stroke="black" stroke-width="3" stroke-linecap="round"/>
		...
		plot, err := DrawSmoothFrom0(200, 200, 5, 5, []uint8{0, 1, 2, 3}, []uint8{0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
...
<path d="M 16.00 187.00 C 16.00,187.00 66.729,174.77 77.33,168.30 C 98.23,155.56 123.017,131.29 138.67,112.20 C 138.67,112.20 173.212,63.84 200.00,18.70 " fill="none" stroke="black" stroke-width="3" stroke-linecap="round"/>
		...
		plot, err := DrawSmoothFrom0(200, 200, 5, 5, []float32{0, 1, 2, 3}, []float32{0, 1, 4, 9}, "x", "y")
		if err != nil {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: nil\n", red, testId, normal, err)
		} else if plot != check {
			t.Errorf("%sTest %d failed%s\tgot: %s, want: %s\n", red, testId, normal, plot, check)
	...
	}
	{
		testId = 3
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFrom0(200, 400, 10, 10, []float32{3, 0, 1, 2, 3}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 4
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFrom0(200, 400, 10, 10, []float32{}, []float32{9, 4, 1, 0, 1, 4, 9}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFrom0(200, 400, 10, 10, []float32{9, 4, 1, 0, 1, 4, 9}, []float32{}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
	...
	}
	{
		testId = 5
		t.Logf("Test %d\tstart", testId)
		_, err := DrawSmoothFrom0(200, 400, 10, 10, []float32{1, -2, 3}, []float32{1, 2, 3}, "x", "y")
		if err == nil {
			t.Errorf("%sTest %d failed%s\tgot: nil, want: error\n", red, testId, normal)
		} else {
			t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
...
func TestDrawSmoothFloat64(t *testing.T) {
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawSmoothFloat64(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawSmoothInt(t *testing.T) {
	type testCase struct {
		x, y []int
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawSmoothInt(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawSmoothInt64(t *testing.T) {
	type testCase struct {
		x, y []int64
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawSmoothInt64(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
	...
	TestList := []testCase{
		{
			x: []int64{-3, -2, -1, 0, 1, 2, 3},
			y: []int64{9, 4, 1, 0, 1, 4, 9},
			s: Style{
				TotalHeight:   300,
				TotalWidth:    300,
				XDivisionsQty: 0,
...
func TestDrawSmoothFloat64From0(t *testing.T) {
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawSmoothFloat64From0(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawSmoothIntFrom0(t *testing.T) {
	type testCase struct {
		x, y []int
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawSmoothIntFrom0(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
...
func TestDrawSmoothInt64From0(t *testing.T) {
	type testCase struct {
		x, y []int64
		s    Style
		plot string
	...
	doTest := func(c testCase) {
		t.Logf("Test %d\tstart", testId)
		plot, err := c.s.DrawSmoothInt64From0(c.x, c.y)
		if err != nil {
			if c.err != nil {
				t.Logf("%sTest %d  success%s\t%s\n", green, testId, normal, "")
			} else {
